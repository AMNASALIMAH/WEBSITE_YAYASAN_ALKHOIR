...
<div class="animate-in">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 mb-2">Edit Anggota Organisasi</h1>
                <p class="text-gray-600">Perbarui data anggota struktur organisasi yayasan</p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-lg p-8">
        <form action="{{ route('admin.struktur_organisasi.update', $strukturOrganisasi->id) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            @csrf
            @method('PUT')
                ...
                @if($strukturOrganisasi->foto)
                    <div class="mb-6">
                        ...
                        <div class="relative inline-block">
                            <img src="{{ Storage::url($strukturOrganisasi->foto) }}" 
                            ...
                            <div class="absolute inset-0 bg-black bg-opacity-0 hover:bg-opacity-20 transition-all duration-200 rounded-lg flex items-center justify-center">
                                <span class="text-white opacity-0 hover:opacity-100 text-xs font-medium">Foto Saat Ini</span>
                            </div>
                        </div>
                    </div>
                @endif
                ...
                <div class="space-y-4">
                    <div>
                        <label for="foto" class="block text-sm font-medium text-gray-700 mb-2">
                            Upload Foto Baru <span class="text-gray-500">(Opsional)</span>
                        </label>
