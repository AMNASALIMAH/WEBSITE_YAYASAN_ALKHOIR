...
<div class="animate-in">
    ...
    <div class="mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div class="mb-4 sm:mb-0">
                <h1 class="text-3xl font-bold text-gray-900 mb-2">SD Tahfidz Al-Khoir</h1>
                <p class="text-gray-600">Kelola konten program: sejarah, visi, misi & tujuan, profil ketua program, fasilitas.</p>
            </div>
            <div class="flex space-x-3">
                <a href="{{ route('admin.management.program_unit.index', 'sd-tahfidz-alkhoir') }}" 
    ...
    @else
        ...
        <div class="text-center py-12">
            ...
            <p class="text-gray-500 mb-6">Data SD Tahfidz Al-Khoir belum ditambahkan. Silakan tambahkan data terlebih dahulu.</p>
            <a href="{{ route('admin.management.program_unit.index', 'sd-tahfidz-alkhoir') }}" 
