...
<div class="animate-in">
    ...
    <div class="mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div class="mb-4 sm:mb-0">
                <h1 class="text-3xl font-bold text-gray-900 mb-2">Tambah Data - {{ $typeLabel }}</h1>
                <p class="text-gray-600">Isi form di bawah untuk menambahkan data baru</p>
            </div>
    ...
    <div class="bg-white shadow-lg rounded-xl p-8">
        <form method="POST" action="{{ route('admin.management.program_unit.store', $type) }}" class="space-y-6">
            @csrf
            ...
            <div class="space-y-2">
                ...
                <textarea name="sejarah" rows="4" 
                          ...
                          placeholder="Tuliskan sejarah..."></textarea>
                @error('sejarah')
            ...
            <div class="space-y-2">
                ...
                <textarea name="visi" rows="3" 
                          ...
                          placeholder="Tuliskan visi..."></textarea>
                @error('visi')
                    <p class="text-sm text-red-600 flex items-center">
                        <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
            ...
            <div class="space-y-2">
                ...
                <textarea name="misi_tujuan" rows="4" 
                          ...
                          placeholder="Tuliskan misi & tujuan..."></textarea>
                @error('misi_tujuan')
                    <p class="text-sm text-red-600 flex items-center">
                        <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
            ...
            <div class="space-y-2">
                ...
                <textarea name="profil_ketua_program" rows="4" 
                          ...
                          placeholder="Tuliskan profil ketua program..."></textarea>
            ...
            <div class="space-y-2">
                ...
                <textarea name="fasilitas" rows="4" 
                          ...
                          placeholder="Tuliskan fasilitas..."></textarea>
                @error('fasilitas')
                    <p class="text-sm text-red-600 flex items-center">
                        <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
