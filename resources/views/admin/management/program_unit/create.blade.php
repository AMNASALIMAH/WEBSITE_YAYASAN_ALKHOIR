...
<div class="max-w-3xl mx-auto">
    <div class="mb-6">
        <h1 class="text-2xl font-semibold text-gray-800">Tambah Data - {{ $typeLabel }}</h1>
    </div>

    <div class="bg-white shadow rounded-lg p-6">
        <form method="POST" action="{{ route('admin.management.program_unit.store', $type) }}" class="space-y-4">
            @csrf

            <div>
                <label class="block text-sm font-medium text-gray-700">Sejarah</label>
                <textarea name="sejarah" rows="4" class="mt-1 block w-full border-gray-300 rounded-md" placeholder="Tuliskan sejarah..."></textarea>
            ...
            <div>
                ...
                <textarea name="visi" rows="3" class="mt-1 block w-full border-gray-300 rounded-md" placeholder="Tuliskan visi..."></textarea>
            ...
            <div>
                ...
                <textarea name="misi_tujuan" rows="4" class="mt-1 block w-full border-gray-300 rounded-md" placeholder="Tuliskan misi & tujuan..."></textarea>
            ...
            <div>
                ...
                <textarea name="profil_ketua_program" rows="4" class="mt-1 block w-full border-gray-300 rounded-md" placeholder="Tuliskan profil ketua program..."></textarea>
            ...
            <div>
                ...
                <textarea name="fasilitas" rows="4" class="mt-1 block w-full border-gray-300 rounded-md" placeholder="Tuliskan fasilitas..."></textarea>
