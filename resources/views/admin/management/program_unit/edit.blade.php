...
<div class="animate-in">
    ...
    <div class="mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div class="mb-4 sm:mb-0">
                <h1 class="text-3xl font-bold text-gray-900 mb-2">Ubah Data - {{ $typeLabel }}</h1>
                <p class="text-gray-600">Edit informasi data yang sudah ada</p>
            </div>
    ...
    <div class="bg-white shadow-lg rounded-xl p-8">
        <form method="POST" action="{{ route('admin.management.program_unit.update', [$type, $item->id]) }}" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-2">
                ...
                <textarea name="sejarah" rows="4" 
                          ...
                          placeholder="Tuliskan sejarah...">{{ old('sejarah', $item->sejarah) }}</textarea>
                @error('sejarah')
            ...
            <div class="space-y-2">
                ...
                <textarea name="visi" rows="3" 
                          ...
                          placeholder="Tuliskan visi...">{{ old('visi', $item->visi) }}</textarea>
                @error('visi')
                    <p class="text-sm text-red-600 flex items-center">
                        <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
            ...
            <div class="space-y-2">
                ...
                <textarea name="misi_tujuan" rows="4" 
                          ...
                          placeholder="Tuliskan misi & tujuan...">{{ old('misi_tujuan', $item->misi_tujuan) }}</textarea>
                @error('misi_tujuan')
                    <p class="text-sm text-red-600 flex items-center">
                        <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
            ...
            <div class="space-y-2">
                ...
                <textarea name="profil_ketua_program" rows="4" 
                          class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 transition-colors duration-200 resize-none" 
                          placeholder="Tuliskan profil ketua program...">{{ old('profil_ketua_program', $item->profil_ketua_program) }}</textarea>
                @error('profil_ketua_program')
                    <p class="text-sm text-red-600 flex items-center">
                        <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                        </svg>
            ...
            <div class="space-y-2">
                ...
                <textarea name="fasilitas" rows="4" 
                          ...
                          placeholder="Tuliskan fasilitas...">{{ old('fasilitas', $item->fasilitas) }}</textarea>
                @error('fasilitas')
                    <p class="text-sm text-red-600 flex items-center">
                        <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
            ...
            <div class="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200">
                ...
                <a href="{{ route('admin.management.program_unit.index', $type) }}" 
                   class="inline-flex items-center justify-center px-6 py-3 bg-gray-100 text-gray-700 font-medium rounded-lg hover:bg-gray-200 transition-all duration-200">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
