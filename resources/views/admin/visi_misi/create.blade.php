...
<div class="animate-in">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 mb-2">Tambah Visi, Misi & Tujuan</h1>
                <p class="text-gray-600">Tambahkan informasi visi, misi, dan tujuan yayasan</p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-lg p-8">
        <form action="{{ route('admin.visi_misi.store') }}" method="POST" class="space-y-8">
            @csrf
            ...
            <div class="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200">
                <button type="submit" 
                        class="flex-1 inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-medium rounded-lg shadow-lg hover:from-blue-700 hover:to-blue-800 transform hover:scale-105 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
