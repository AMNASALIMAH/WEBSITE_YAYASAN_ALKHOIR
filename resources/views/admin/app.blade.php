    ...
    <div class="admin-layout">
        ...
        <div class="main-content-container" id="main-wrapper">
            ...
            <main class="flex-1 overflow-y-auto p-6 bg-gradient-to-br from-gray-50 to-white" id="main-content">
                <!-- Flash Messages -->
                @if(session('success'))
                    <div class="mb-4 bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative animate-in" role="alert">
                ...
                @if(session('error'))
                    <div class="mb-4 bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative animate-in" role="alert">
                        <div class="flex items-center">
                            <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
